package com.programmers.Assignment.configures.web;
...
public class SimplePageRequestHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(
        ...
        // TODO 구현이 필요 합니다.
        Long offset = offsetString == null
                || offsetString.equals("")
                || Long.parseLong(offsetString) > Long.MAX_VALUE
                || Long.parseLong(offsetString) < 0 ? 0 : Long.parseLong(offsetString);

        int size = sizeString == null
                || sizeString.equals("")
                || Integer.parseInt(sizeString) > 5
                || Integer.parseInt(sizeString) < 1
                ? 5 : Integer.parseInt(sizeString);
